	...
	function closeBom(select: boolean) {
		if (currentBom.value.type === 'prompt') {
			...
			if (promptForm.options.forms) {
				for (const form of promptForm.options.forms) {
