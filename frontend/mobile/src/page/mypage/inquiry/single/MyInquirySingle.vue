								...
								>
									<div class="mm_inline">
										...
										<button
											...
											class="btn_modify"
											href="#"
											@click.prevent="_e => overlayMyInquirySingleUpdate(_e, qna.id)"
										>
...
<script setup lang="ts">
	...
	const overlayMyInquirySingleUpdate = (_e: MouseEvent, id: number) => {
		openOverlay(defineAsyncComponent(() => import('@/page/mypage/inquiry/single/update/MyInquirySingleUpdate.vue')), {
			props: { id },
