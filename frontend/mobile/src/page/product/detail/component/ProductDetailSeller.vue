							...
							<table>
								<tbody>
									<tr>
										...
										<td>{{ delivery_info.shipping_center_name }}</td>
									</tr>
									<tr>
										<th scope="row">
											<b>배송료</b>
									...
									<tr>
										...
										<td>
											{{ delivery_info.today_exportable_message === '시 이전 결제 시 당일 출고됩니다.' ? '' : delivery_info.today_exportable_message }}
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table>
								<tbody>
									<tr>
										...
										<td>{{ return_delivery_info.company_name }}</td>
									</tr>
									<tr>
										<th scope="row">
											<b>연락처</b>
										</th>
										<td>{{ return_delivery_info.tel }}</td>
									</tr>
									<tr>
										<th scope="row">
											<b>택배사</b>
										</th>
										<td>{{ return_delivery_info.shipping_company }}</td>
									</tr>
									<tr>
										<th scope="row">
											<b>반품 배송비</b>
										...
										<td>
											구매자 귀책: {{ number((delivery_info?.shipping_price || 0) + return_delivery_info.return_shipping_price ) }}원
											또는 {{ number(return_delivery_info.return_shipping_price) }}원
										</td>
									</tr>
									<tr>
										<th scope="row">
										...
										<td>{{ return_delivery_info.return_address }}</td>
									</tr>
								</tbody>
							</table>
						</template>
...
<script setup lang="ts">
	...
	const { delivery_info, return_delivery_info } = props.goodsDetail;
