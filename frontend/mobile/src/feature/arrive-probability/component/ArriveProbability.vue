<template>
	...
	<div class="m...info-ship">
		...
		<dropdown>
			<template #button>
				<i class="ico_ship"></i><strong>{{ date(averageArrivalProbability.average_date, 'MM월 DD일(ddd)') }}</strong> 도착 확률<strong>{{ averageArrivalProbability.probability }}<sub>%</sub></strong>
			</template>
			<template #content>
				<template
