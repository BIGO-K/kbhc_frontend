	...
	<layout title="기획전">
		<div class="mm_event">
			...
			<div class="mm_event-head">
				<h2><b>EXOPLORE OCEANIA EXOPLOR E OCEANIA</b></h2>
				<!-- SNS 공유 -->
				<button
					type="button"
					class="btn_sns-share"
				...
				<dropdown v-model:is-active="isDropdown">
					...
					<template #content>
						<ul>
							...
							>
								<a
									:href="`#promo_prod_section_${group.id}`"
...
<script setup lang="ts">
	...
	const planningEvent: PlanningEvent = {
		id: 1234567,
		title: 'EXOPLORE OCEANIA EXOPLOR E OCEANIA',
		is_use_comment: true,
		sections: [
			{
				id: 100,
				...
				`,
				pc_html: '',
				goods_list: useFakeCreator().goods(7),
			},
			{
				id: 200,
				title: '',
				...
				`,
				pc_html: '',
				goods_list: useFakeCreator().goods(4),
			},
			{
				id: 300,
				title: '',
		...
		groups: [
			...
			},
			{
				...
				has_pc_image: false,
				mobile_alt: 'MD PICK',
				mobile_image_url: '/image/_sample/promo_detail_title_1.png',
				mobile_link: '',
				pc_alt: '',
				pc_image_url: '',
				pc_link: '',
			...
			},
			{
				...
				has_pc_image: false,
				mobile_alt: 'FASHION',
				mobile_image_url: '/image/_sample/promo_detail_title_2.png',
				mobile_link: '',
				pc_alt: '',
				pc_image_url: '',
				pc_link: '',
	...
	function moveAnchor(group: PlanningEventGroup) {
		selectedGroupTitle.value = group.title;
		const target = document.querySelector<HTMLElement>(`#promo_prod_section_${group.id}`);
		if (!target) return;
