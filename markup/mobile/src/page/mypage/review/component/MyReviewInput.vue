<template>
	...
	<section>
		...
		-->
		<div class="m_review-write-starscore">
			<ul>
				<li>
					<button type="button">
	...
	<review-template-satisfy-setting v-if="true"></review-template-satisfy-setting>

	<div class="mm_inner">
		<review-template-body v-if="true"></review-template-body>
