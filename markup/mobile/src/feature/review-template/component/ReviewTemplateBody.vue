<template>
	...
	<div class="mm_flex T=equal">
		...
		<div class="mm_form_mix-linked">
			<form-text
				v-model="reviewTemplateWeight"
				placeholder="몸무게"
			></form-text>
			<span class="text_linked">kg</span>
		</div>
		<div class="mm_form_mix-linked">
			<form-select v-model="sortShoesSize">
				<option>발 사이즈</option>
			</form-select>
...
<script setup lang="ts">
	...
	const sortShoesSize = ref('');
	const reviewTemplateTall = ref('');
	const reviewTemplateWeight = ref('');
</script>
