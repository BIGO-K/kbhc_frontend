<template>
	<div class="m_mysize">
		...
		<div class="mm_radio-list T=chain">
			<ul>
				...
				<li>
					<form-radio name="dev_radio-fit">
						<b class="mm_block">
							<span class="text_label">XS이하</span>
						</b>
					</form-radio>
				</li>
				<li>
				...
				<li>
					<form-radio name="dev_radio-fit">
						<b class="mm_block">
							<span class="text_label">XXL이상</span>
						</b>
					</form-radio>
				</li>
			</ul>
		...
		<div class="mm_radio-list T=chain">
			<ul>
				<li>
					<form-radio name="dev_radio-shoes-category">
						<b class="mm_block">
							<span class="text_label">선택안함</span>
						</b>
					</form-radio>
		...
		<div class="mm_radio-list T=chain">
			<ul>
				<li>
					<form-radio name="dev_radio-shoes-size">
						<b class="mm_block">
							<span class="text_label">선택안함</span>
						</b>
					</form-radio>
				...
				<li>
					<form-radio name="dev_radio-shoes-size">
						<b class="mm_block">
							<span class="text_label">210 이하</span>
						</b>
					</form-radio>
				</li>
				<li>
					<form-radio name="dev_radio-shoes-size">
						<b class="mm_block">
							<span class="text_label">215</span>
						</b>
					</form-radio>
				</li>
				<li>
					<form-radio name="dev_radio-shoes-size">
						<b class="mm_block">
							<span class="text_label">220</span>
						</b>
					</form-radio>
				</li>
				<li>
				...
				<li>
					<form-radio name="dev_radio-shoes-size">
						<b class="mm_block">
							<span class="text_label">295</span>
						</b>
					</form-radio>
				</li>
				<li>
